...
interface PremiumFeaturesRealProps {
  organization: SessionOrganization;
  onUpgrade: () => void;
}

const PremiumFeaturesReal: React.FC<PremiumFeaturesRealProps> = ({
  organization,
  onUpgrade,
}) => {
  const features = [
    {
      ...
      icon: MapPin,
      highlighted: true,
      available: organization.plan === 'premium' || organization.features.includes('Fleet Map'),
    },
    {
      ...
      icon: BarChart3,
      highlighted: false,
      available: organization.plan === 'premium' || organization.features.includes('Advanced Analytics'),
    },
    {
      id: 'api-access',
      name: 'API Access',
      ...
      icon: Zap,
      highlighted: false,
      available: organization.plan === 'premium' || organization.features.includes('API Access'),
    },
  ];
          ...
          {isPremium && (
            <div className="pt-4 border-t">
              <div className="text-center space-y-2">
                ...
                <div className="text-xs text-muted-foreground">
                  {organization.nextBillingDate && `Next billing: ${new Date(organization.nextBillingDate).toLocaleDateString()}`}
                </div>
...
export default PremiumFeaturesReal;
