...
-- Enhance the get_org_feature_access function to properly check billing exemptions
...
BEGIN
  ...
  -- If there's an active exemption, grant access
...
-- Also enhance the calculate_org_user_billing_with_exemptions function to be more robust
