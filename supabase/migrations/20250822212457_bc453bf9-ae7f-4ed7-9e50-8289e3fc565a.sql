...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Users can view work orders for their organization'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'work_orders' 
    AND policyname = 'Users can create work orders for their organization'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'work_orders' 
    AND policyname = 'Users can update work orders for their organization'
  ) THEN
